...
public class Controller implements ActionListener, MouseListener {
	...
	public static final String SONG1 = "music/Untitled5.mp3";
	public static final String SONG2 = "music/Untitled2.mp3";
	public static final String SONG3 = "music/Untitled4.mp3";
	...
	public Controller() throws IOException {
		...
		mp3player = new MP3Player(new File(SONG2));
		mp3player.play();
		mp3player.addMouseListener(this);
		...
		if (e.getSource() instanceof JButton) {
			...
			if (button.getName().equals("startGame_1")) {
				if (view.getFirstTextField().getText().equals("") || view.getSecondTextField().getText().equals("")) {
					...
					mp3player.stop();
					mp3player = new MP3Player(new File(SONG1));
					mp3player.play();
				}
			}
	...
	private void afterAction() {
		...
		if (model.checkGameOver() != null) {
			...
			mp3player.stop();
			mp3player = new MP3Player(new File(SONG3));
			mp3player.play();
		}
	}
